	...
	<div class="panel-body">
		<div class="row">
			<div class="form-group">
				<div class="col-sm-6">
					{!! Form::label('Name') !!}
					{!! Form::text('name', isset($armour) ? $armour->name : null, ['class' => 'form-control']) !!}
				</div>
				<div class="col-sm-6">
					{!! Form::label('Armour Value') !!}
					{!! Form::text('armour_value', isset($armour) ? $armour->armour_value : null, ['class' => 'form-control']) !!}
				</div>
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('Description') !!}
			{!! Form::textarea('description', isset($armour) ? $armour->description : null, ['class' => 'form-control']) !!}
		</div>
		<hr>
		...
		@else
			...
			<?php $index = 1; ?>
			@foreach($armour->effects as $effect)
...
@section('scripts')
	...
	<script type="text/javascript">
		<?php if(isset($armour)): ?>
			<?php $effectsIndex = count($armour->effects); ?>
